...
Linked from the footer, along with Feedback & Reporting, Scripts, Investments and Education & Job Planner. **Scripts** is a list of userscripts and tools worth having, each panel a link and a short description. **Education & Job** has its own aqua button at the top of the page now, and is still a placeholder while it is built: opening it turns the page aqua and leaves one orange **Investments** button up top to come back by. Docs holds this page, the Investment Logic explainer, the changelog, the licence, and one other thing. **Back to Stonking** at the bottom returns you to the app, as does clicking the title. Terms of Service carries the Torn-required data table and the kudos list.
